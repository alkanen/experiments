...
HittableList block_scene()
{
  ...
  auto texture_material = new Texture(
    green_meadow_width,
    green_meadow_height,
    green_meadow_data,
    0
...
int main(int argc, char *argv[])
{
  ...
  std::cerr << "Average " << (sample_count / ((double)width * height)) << " samples per pixel" << std::endl;
