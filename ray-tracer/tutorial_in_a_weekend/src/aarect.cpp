...
XzRect::XzRect(double x0, double x1, double z0, double z1, double k, Material *mat)
  : x0(x0)
  , x1(x1)
  , z0(z0)
  , z1(z1)
...
double XzRect::pdf_value(const Point3 &o, const Vec3 &v) const
{
  HitRecord rec;
...
YzRect::YzRect(double y0, double y1, double z0, double z1, double k, Material *mat)
  : y0(y0)
  , y1(y1)
  , z0(z0)
  , z1(z1)
